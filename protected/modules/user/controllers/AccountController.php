...
class AccountController extends InstagramController
{
    ...
    public function actionRemove($instagram_id = 0) {
		...
		$instagram_id = isset($_REQUEST["instagram_id"]) ? $_REQUEST["instagram_id"] : 0;
        ...
        User::model()->deleteAll('id=:user_child_id', array(
                ':user_child_id' => $user_child_id
            ));		
