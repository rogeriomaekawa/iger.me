	...
	<div class="account-index-list container">
			...
			<div class="row clearfix">
				...
				?>
					...
					<div class="span4">
						<div class="account-entry nice-block mb20" data-user-id="<?php echo $model->user->instagram_id;?>" data-username="<?php echo $model->user->username; ?>">
							<img src="<?php echo $model->user->avatar;?>" width="50" style="float:left"/>
							<div class="account-head">
								
								<a href="<?php echo Yii::app()->createUrl("/user/activity");?>/?instagram_id=<?php echo $model->user->instagram_id;?>" class="account-avatar" alt="softdevelopinc">
							...
							<div class="mt10">
								...
								<a href="<?php echo Yii::app()->createUrl("/user/account/select/");?>/<?php echo $model->user->instagram_id;?>" class="btn btn-plain mr10">Settings</a>
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu">
										<li><a href="<?php echo Yii::app()->createUrl("/user/account/select/");?>/<?php echo $model->user->instagram_id;?>?next=/profile">Profile</a></li>
										<li><a href="<?php echo Yii::app()->createUrl("/user/account/select/");?>/<?php echo $model->user->instagram_id;?>?next=/likes">Likes</a></li>
										<li class="divider"></li>
										<li><a href="<?php echo Yii::app()->createUrl("/user/account/remove/");?>?instagram_id=<?php echo $model->user->instagram_id;?>">Log out</a></li>
									</ul>
								</div>
							</div>
						</div>
