...
<div class="" id="">
	<header>
		...
		<li class="">
			<a href="<?php echo Yii::app()->createUrl("/site/prices");?>" >Prices</a>
		...
		<li class="">
			<a href="<?php echo Yii::app()->createUrl("/site/blog");?>" >Blog</a>
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="span4">
					<a href="<?php echo Yii::app()->createUrl("/site/index");?>" class="logo-footer"></a>
				</div>
				<div class="span4">
	...
	<div id="popup-account-signup" class="popup popup-medium">
		...
		?>
			...
			<div class="mb10">
				By signing up, you agree to the <a href="<?php echo Yii::app()->createUrl("/site/terms");?>" target="_blank">Terms of Service</a>.
			</div>
			<div>
			...
			<div>
				<a href="<?php echo Yii::app()->createUrl("/site/signgoogle");?>" id="google_login" class="btn btn-plain btn-big btn-danger" style="float:left;margin-right:2em;margin-top:2em" >Log in Google</a>
			</div>
            <div>
				<a href="<?php echo Yii::app()->createUrl("/site/signfacebook");?>" id="facebook_login" class="btn btn-plain btn-big btn-danger" style="margin-top:2em" >Log in Facebook</a>
			</div>            
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$('#account-signup-form').submit(function(e) {
					$.ajax({
						url : '<?php echo Yii::app()->createUrl("/user/register/index");?>',
						type : 'POST',
						...
						success : function(data) {
							...
							if (json.errors == '')
								window.location = "<?php echo Yii::app()->createUrl("/user/account");?>";
	...
	<form action="<?php echo Yii::app()->createUrl("/user/auth/login");?>" id="account-login-form" class="form-horizontal mb0" method="post">
		<div class="control-group field-wrap" data-field="email">
        ...
        <div>
            <a href="<?php echo Yii::app()->createUrl("/site/signgoogle");?>" id="google_login" class="btn btn-plain btn-big btn-danger" style="float:left;margin-right:2em;margin-bottom:2em" >Log in Google</a>
        </div>
        <div>
            <a href="<?php echo Yii::app()->createUrl("/site/signfacebook");?>" id="facebook_login" class="btn btn-plain btn-big btn-danger" style="margin-bottom:2em" >Log in Facebook</a>
        </div>                    
		<div class="mb10">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#account-login-form').submit(function(e) {
				$.ajax({
					url : '<?php echo Yii::app()->createUrl("/user/auth/login");?>',
					type : 'POST',
					data : $(this).serializeArray(),
					success : function(data) {
	...
	<script src="<?php echo Yii::app()->request->baseUrl.WWWROOT_FRONTEND; ?>/js/jquery-1.11.0.js?v=114"></script>
